...
const NewAddress = ({
  ...
  const handleSubmit = () => {
    switch (true) {
      ...
      default:
        axios
          .post("https://localhost:7241/api/Order/AddressOder", NewAddressAdd, {
            headers: {
      ...
      <div className="log-add-newAddress">
        ...
        <div className="add-FullName-PhoneNumber">
          <div className="FullName-logAdd">
            ...
            {MsFullName && <p id="massage-er-input">Vui lòng điền Họ và Tên</p>}
          </div>
          <div className="FullName-logAdd">
            <input
              type="text"
        ...
        {MsAllNull && <h5>Vui lòng cung cấp thông tin đầy đủ nhận hàng</h5>}
