...
const ToPay = () => {
  ...
  useEffect(() => {
    axios
      .get("https://localhost:7241/api/Order/OrderFailed", {
        headers: {
  ...
  const handlePayNow = (order) => {
    ...
    axios
      .post(`https://localhost:7241/api/Order/Pay`, paymentMethodSelect, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
      })
              ...
              {order.orders.map((shop) => (
                <div className="toPay-log-shop" key={shop.shopId}>
                  <div className="toPay-nameShop">
                    ...
                    <div className="toPay-Product-text">Thanh Toán Lại</div>
                  </div>
